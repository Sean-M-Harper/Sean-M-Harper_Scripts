...
#Microsoft Office 2008 for Mac - PLIST fix.
...
#kills all Microsoft Office processes that would affect the plist copy process
	...
	cp /Volumes/CasperShare/Scripts/Office-plist/2008/com.microsoft.* /System/Library/User\ Template/English.lproj/Library/Preferences/
...
for u in `dscl . -list /Users`
	...
	cp /Volumes/CasperShare/Scripts/Office-plist/2008/com.microsoft.* /Users/$u/Library/Preferences/
